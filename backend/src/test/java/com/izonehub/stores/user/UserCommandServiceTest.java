...
class UserCommandServiceTest {
    ...
    void refusesCreatingSystemAdministrator() {
        ...
        UserCommandService svc = new UserCommandService(repo, new BCryptPasswordEncoder(), new PasswordPolicy(), emailGateway, "https://stores.nsv.co.zw");

        assertThatThrownBy(() -> svc.createUser("Admin", "a@example.com", "Password1!", Set.of(Role.SYSTEM_ADMINISTRATOR), null, null))
