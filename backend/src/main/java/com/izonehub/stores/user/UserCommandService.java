    ...
    public AppUser createUser(String fullName, String email, String temporaryPassword,
        ...
        try {
            ...
            String body = "Welcome to the NSV Stores Management System.\n\n"
                    ...
                    + "Download the training video package here: https://media.nsv.co.zw/training/NSV_Stores_Training_Videos.zip (large file — Wi-Fi recommended). It's also available anytime from the 'Training Videos' link in the sidebar once you're logged in:\n"
